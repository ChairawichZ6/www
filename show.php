...
?>
  <tr>
    ...
    <td>
        <input class="btn btn-danger" type="button" value="แก้ไข" onclick="window.location.href='https://webfook.azurewebsites.net/edit.php?name=<?php echo $Result['Name'];?>&comment=<?php echo $Result['Comment'];?>&link=<?php echo $Result['Link'];?>&id=<?php echo $Result['ID'];?>'" /> 
        <input class="btn btn-warning" type="button" value="ลบ" onclick="window.location.href='https://webfook.azurewebsites.net/delete.php?rn=<?php echo $Result['ID'];?>'" />
    </td>
   </tr>
<?php
}
