...
<body class="container text-center" style="height: 100vh; background: url("https://mdbootstrap.com/img/Photos/Horizontal/Nature/full page/img(11).jpg");background-repeat: no-repeat;background-size: cover;">>
<?php
    $Name=$_GET['name'];
